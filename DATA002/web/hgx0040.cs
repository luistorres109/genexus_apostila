...
namespace GeneXus.Programs {
   public class hgx0040 : GXHttpHandler
   {
      public hgx0040( )
      {
      ...
      public hgx0040( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( ( nGotPars == 0 ) )
         {
            ...
            AV7pEstCod = (int)(NumberUtil.Val( gxfirstwebparm, "")) ;
         }
      }
      ...
      {
         WriteHtmlText( "<title>") ;
         WriteHtmlText( "Selection List Cadastro de Estados") ;
         ...
         skipLines(1);
         WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return GXValidForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"POST\" ACTION=\""+formatLink("hgx0040.aspx") + "?" + UrlEncode("" +AV7pEstCod)+"\""+">") ;
      ...
      protected void RenderHtmlCloseForm0A2( )
      {
         ...
         gx_hidden_field( "GXH__CESTCODIGO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5cEstCod), 9, 0, ".", "")));
         gx_hidden_field( "GXH__CESTUF", StringUtil.RTrim( AV6cEstUF));
         /* Send saved values. */
      ...
      protected void START0A2( )
      {
         ...
         Form.Meta.addItem("Description", "Selection List Cadastro de Estados", 0) ;
         context.wjLoc = "" ;
         ...
         if ( ( String.CompareOrdinal(context.GetRequestMethod( ).TrimEnd(' '), "POST".TrimEnd(' ') ) == 0 ) )
         {
            if ( ((String.CompareOrdinal("".TrimEnd(' '), StringUtil.RTrim( context.wjLoc).TrimEnd(' ') )==0)) && ( context.nUserReturn != 1 ) && ( wbErr == false ) )
            {
               ...
               if ( ( StringUtil.Len( sEvt) > 0 ) )
               {
                  ...
                  if ( ( NumberUtil.CToN( cgiGet( "GXH__CESTCODIGO"), "", "") != Convert.ToDecimal( AV5cEstCod )) )
                  {
                     Grid1_nFirstRecordOnPage = 0 ;
                  }
                  if ( ( String.CompareOrdinal(cgiGet( "GXH__CESTUF").TrimEnd(' '), AV6cEstUF.TrimEnd(' ') ) != 0 ) )
                  {
                     Grid1_nFirstRecordOnPage = 0 ;
                  }
      ...
      protected void sendrow_132( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_13_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtEstCodigo_Link = "javascript:GX_js_return"+"("+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A23EstCodi), 9, 0, ".", "")))+"')" ;
            gx_single_line_edit2( edtEstCodigo_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A23EstCodi), 9, 0, ".", "")), 18, 9, 1, 0, 0, 0, 0, 0, edtEstCodigo_Link, "", StyleString, ClassString, ROClassString, StringUtil.Format( (decimal)(A23EstCodi), "ZZZZZZZZ9"), "", 0, edtEstCodigo_Jsonclick, "", 13, 0, 1, "'HLP_HGx0040.htm'");
            WriteHtmlTextNl( "</td>") ;
            /* Subfile cell */
            sStyleString = ((1==0) ? "display:none;" : "") ;
            ...
            StyleString = ((subGrid1_Backstyle==0) ? "background:transparent;" : "") + "" ;
            ROClassString = ClassString ;
            gx_single_line_edit2( edtEstUF_Internalname, StringUtil.RTrim( A24EstUF), 14, 2, 1, 0, 0, 0, 0, 0, "", "", StyleString, ClassString, ROClassString, StringUtil.RTrim( StringUtil.Format( A24EstUF, "@!")), "", 0, edtEstUF_Jsonclick, "", 13, 0, 1, "'HLP_HGx0040.htm'");
            WriteHtmlTextNl( "</td>") ;
            WriteHtmlTextNl( "</tr>") ;
            ...
            edtEstUF_Internalname = "ESTUF_"+sGXsfl_13_idx ;
         }
      ...
      protected void RF0A2( )
      {
         ...
         if ( ((String.CompareOrdinal("".TrimEnd(' '), StringUtil.RTrim( context.wjLoc).TrimEnd(' ') )==0)) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A24EstUF = H000A2_A24EstUF[0] ;
               n24EstUF = H000A2_n24EstUF[0] ;
               A23EstCodi = H000A2_A23EstCodi[0] ;
               /* Execute user event: E150A2 */
               E150A2 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         lV6cEstUF = StringUtil.PadR( StringUtil.RTrim( AV6cEstUF), 2, "%") ;
         /* Using cursor H000A3 */
         pr_default.execute(1, new Object[] {AV5cEstCod, lV6cEstUF});
         Grid1_nRecordCount = H000A3_AGrid1_nRe[0] ;
         pr_default.close(1);
      ...
      protected void STRUP0A0( )
      {
         ...
         if ( ( String.CompareOrdinal(context.GetRequestMethod( ).TrimEnd(' '), "POST".TrimEnd(' ') ) == 0 ) )
         {
            ...
            {
               AV5cEstCod = (int)(NumberUtil.CToN( cgiGet( edtavCestcodigo_Internalname), "", "")) ;
            }
            AV6cEstUF = StringUtil.Upper( cgiGet( edtavCestuf_Internalname)) ;
      ...
      protected void wb_table2_5_0A2e( bool wbgen )
      {
         if ( ( wbgen == true ) )
         {
            ...
            ClassString = "S4" ;
            StyleString = "" + "" ;
            gx_button_ctrl2( 1, bttBtn_first_Internalname, "|<", "", "", StyleString, ClassString, 1, 1, 5, bttBtn_first_Jsonclick, "E\\'GXM_FIRST\\'.", TempTags, "GX_setgridevent("+StringUtil.Str( (decimal)(13), 3, 0)+","+StringUtil.Str( (decimal)(nGXsfl_13_idx), 4, 0)+");", "", "'HLP_HGx0040.htm'");
            TempTags = " " + "gxctx=\"" + "_" + "" + "\"" + " onFocus=\"gxonfocus2(this, " + "16" + "," + "''" + "," + "13" + ")\"" ;
            ClassString = "S4" ;
            StyleString = "" + "" ;
            gx_button_ctrl2( 1, bttBtn_previous_Internalname, "<", "", "", StyleString, ClassString, 1, 1, 5, bttBtn_previous_Jsonclick, "E\\'GXM_PREVIOUS\\'.", TempTags, "GX_setgridevent("+StringUtil.Str( (decimal)(13), 3, 0)+","+StringUtil.Str( (decimal)(nGXsfl_13_idx), 4, 0)+");", "", "'HLP_HGx0040.htm'");
            TempTags = " " + "gxctx=\"" + "_" + "" + "\"" + " onFocus=\"gxonfocus2(this, " + "17" + "," + "''" + "," + "13" + ")\"" ;
            ClassString = "S4" ;
            StyleString = "" + "" ;
            gx_button_ctrl2( 1, bttBtn_next_Internalname, ">", "", "", StyleString, ClassString, 1, 1, 5, bttBtn_next_Jsonclick, "E\\'GXM_NEXT\\'.", TempTags, "GX_setgridevent("+StringUtil.Str( (decimal)(13), 3, 0)+","+StringUtil.Str( (decimal)(nGXsfl_13_idx), 4, 0)+");", "", "'HLP_HGx0040.htm'");
            TempTags = " " + "gxctx=\"" + "_" + "" + "\"" + " onFocus=\"gxonfocus2(this, " + "18" + "," + "''" + "," + "13" + ")\"" ;
            ClassString = "S4" ;
            StyleString = "" + "" ;
            gx_button_ctrl2( 1, bttBtn_last_Internalname, ">|", "", "", StyleString, ClassString, 1, 1, 5, bttBtn_last_Jsonclick, "E\\'GXM_LAST\\'.", TempTags, "GX_setgridevent("+StringUtil.Str( (decimal)(13), 3, 0)+","+StringUtil.Str( (decimal)(nGXsfl_13_idx), 4, 0)+");", "", "'HLP_HGx0040.htm'");
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "<TD align=right>") ;
            TempTags = " " + "gxctx=\"" + "_" + "" + "\"" + " onFocus=\"gxonfocus2(this, " + "19" + "," + "''" + "," + "13" + ")\"" ;
            ClassString = "S4" ;
            StyleString = "" + "" ;
            gx_button_ctrl2( 1, bttBtn_cancel_Internalname, "Close", "", "", StyleString, ClassString, 1, 1, 1, bttBtn_cancel_Jsonclick, "ECANCEL.", TempTags, "GX_setgridevent("+StringUtil.Str( (decimal)(13), 3, 0)+","+StringUtil.Str( (decimal)(nGXsfl_13_idx), 4, 0)+");", "", "'HLP_HGx0040.htm'");
            TempTags = " " + "gxctx=\"" + "_" + "" + "\"" + " onFocus=\"gxonfocus2(this, " + "20" + "," + "''" + "," + "13" + ")\"" ;
            ClassString = "S4" ;
            StyleString = "" + "" ;
            gx_button_ctrl2( 2, bttBtn_help_Internalname, "Help", "", "", StyleString, ClassString, 1, 1, 3, bttBtn_help_Jsonclick, "EHELP.", TempTags, "GX_setgridevent("+StringUtil.Str( (decimal)(13), 3, 0)+","+StringUtil.Str( (decimal)(nGXsfl_13_idx), 4, 0)+");", "", "'HLP_HGx0040.htm'");
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "</TR>") ;
            /* End of table */
            WriteHtmlText( "</table>") ;
      ...
      protected void wb_table2_5_0A2( bool wbgen )
      {
         if ( ( wbgen == true ) )
         {
            ...
            ClassString = "S5" ;
            StyleString = "" + "" ;
            gx_label_ctrl( lblTextblock1_Internalname, 1, 1, 0, "Código do Estado", "", "", 0, lblTextblock1_Jsonclick, "", StyleString, ClassString, "'HLP_HGx0040.htm'");
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "<TD>") ;
            /* Single line edit */
            ...
            ClassString = "S6" ;
            StyleString = "" + "" ;
            gx_single_line_edit2( edtavCestcodigo_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(AV5cEstCod), 9, 0, ".", "")), 9, 9, 1, 0, 1, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.Format( (decimal)(AV5cEstCod), "ZZZZZZZZ9"), TempTags+" onchange=\"gxonchange(this)\" "+" onBlur=\"valid_integer( this,',');;GXOnBlur(7);\"", 0, edtavCestcodigo_Jsonclick, "", 0, 0, 1, "'HLP_HGx0040.htm'");
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "<TD>") ;
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "</TR>") ;
            ...
            ClassString = "S5" ;
            StyleString = "" + "" ;
            gx_label_ctrl( lblTextblock2_Internalname, 1, 1, 0, "UF do Estado", "", "", 0, lblTextblock2_Jsonclick, "", StyleString, ClassString, "'HLP_HGx0040.htm'");
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "<TD>") ;
            /* Single line edit */
            ...
            ClassString = "S6" ;
            StyleString = "" + "" ;
            gx_single_line_edit2( edtavCestuf_Internalname, StringUtil.RTrim( AV6cEstUF), 2, 2, 1, 0, 1, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( StringUtil.Format( AV6cEstUF, "@!")), TempTags+" onchange=\"gxonchange(this)\" "+" onBlur=\"this.value=this.value.toUpperCase();;GXOnBlur(9);\"", 0, edtavCestuf_Jsonclick, "", 0, 0, 1, "'HLP_HGx0040.htm'");
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "<TD align=right>") ;
            TempTags = " " + "gxctx=\"" + "_" + "" + "\"" + " onFocus=\"gxonfocus2(this, " + "10" + "," + "''" + "," + "13" + ")\"" ;
            ClassString = "S4" ;
            StyleString = "" + "" ;
            gx_button_ctrl2( 1, bttBtn_refresh_Internalname, "Search", "", "", StyleString, ClassString, 1, 1, 5, bttBtn_refresh_Jsonclick, "EREFRESH.", TempTags, "GX_setgridevent("+StringUtil.Str( (decimal)(13), 3, 0)+","+StringUtil.Str( (decimal)(nGXsfl_13_idx), 4, 0)+");", "", "'HLP_HGx0040.htm'");
            WriteHtmlText( "</TD>") ;
            WriteHtmlText( "</TR>") ;
            WriteHtmlText( "<TR>") ;
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pEstCod = Convert.ToInt32(obj[0]) ;
      }
      ...
      protected void include_jscripts( )
      {
         ...
         WriteHtmlTextNl( "function GX_js_return( pEstCodigo) {if (opener != null) {if (opener.GXPARAMETERS != null) {") ;
         WriteHtmlTextNl( "GXAssignPromptField(0,pEstCodigo);") ;
         ...
         WriteHtmlTextNl( "<script language=\"JavaScript\" src=\""+convertURL( "hgx0040.js")+"\"></script>") ;
      ...
      protected void initialize_properties( )
      {
         ...
         edtavCestuf_Internalname = "_CESTUF" ;
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "" ;
         lV6cEstUF = "" ;
         H000A2_A24EstUF = new String[] {""} ;
         H000A2_n24EstUF = new bool[] {false} ;
         H000A2_A23EstCodi = new int[1] ;
         n24EstUF = false ;
         Grid1_nRecordCount = 0 ;
         H000A3_AGrid1_nRe = new int[1] ;
         nDoneStart = 0 ;
         edtavCestuf_Internalname = "" ;
         returnInSub = false ;
         ...
         GXt_char6 = "" ;
         GXt_char8 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.hgx0040__default(),
            new Object[][] {
                new Object[] {
               H000A2_A24EstUF, H000A2_n24EstUF, H000A2_A23EstCodi
               }
               , new Object[] {
               H000A3_AGrid1_nRe
               }
      ...
      private int AV7pEstCod ;
      private int idxLst ;
      private int AV5cEstCod ;
      ...
      private String edtEstCodigo_Link ;
      ...
      private String lV6cEstUF ;
      private String edtavCestuf_Internalname ;
      ...
      private String edtavCestuf_Jsonclick ;
      ...
      private IDataReader H000A2 ;
      private IDataStoreProvider pr_default ;
      private String[] H000A2_A24EstUF ;
      private bool[] H000A2_n24EstUF ;
      private int[] H000A2_A23EstCodi ;
      private IDataReader H000A3 ;
      private int[] H000A3_AGrid1_nRe ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private int aP0_pEstCodigo ;
   }

   public class hgx0040__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( ( def == null ) )
       {
          ...
          def= new GeneXus.Data.NTier.ADO.CursorDef[] {
              new GeneXus.Data.NTier.ADO.CursorDef("H000A2", "SELECT [EstUF], [EstCodigo] FROM [ESTADO] WITH (NOLOCK) WHERE ([EstCodigo] >= @AV5cEstCod) AND ([EstUF] like @AV6cEstUF) ORDER BY [EstCodigo] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A2,11,0,false,false )
             ,new GeneXus.Data.NTier.ADO.CursorDef("H000A3", "SELECT COUNT(*) FROM [ESTADO] WITH (NOLOCK) WHERE ([EstCodigo] >= @AV5cEstCod) AND ([EstUF] like @AV6cEstUF) ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A3,1,0,false,false )
          };
       }
    }
