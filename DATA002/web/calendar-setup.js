...
Calendar.setup = function (params) {
	...
	var inputFieldValue = document.forms[0][params.inputField].value;
	var tmp = ["inputField", "displayArea", "button"];
	for (var i in tmp) {
		if (typeof params[tmp[i]] == "string") {
			params[tmp[i]] = getCalParmControl(params[tmp[i]]);
		}
	}
